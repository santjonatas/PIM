...
int main(){
	...
	char entrada_cheia[18]="ENTRADA INTEIRA", meia_entrada[14]="MEIA ENTRADA", insencao[10]="ISENÇÃO";
	...
	char opcao_invalida[150]="\n[ERRO!] Ops! Parece que Você Digitou uma Data Inválida, Selecione uma Data Válida.\n";
	...
	printf("\nAqui você mergulha em um mundo onde a criatividade encontra a inovação, e a beleza se funde com a tecnologia de ponta.");
	...
	menu_principal:
	printf("\n\n\n\n\n\n\n---------------------------------------------------------------------");
	printf("\n[ATENÇÃO] Digite o Número Correspondente à Opção Que Deseja Acessar.");
	printf("\n\n1. Menu Principal");
	printf("\n2. Sair do Programa\n");
    	...
    	case 1:
    		...
    		switch(opcoes_do_menu_principal){
    			...
    			case 2:
    			    ...
    			    printf("\n---COMPRA DE BILHETES---");
    				printf("\n------------------------");
    				printf("\n[ATENÇÃO: Para Comprar um Bilhete, Primeiro é Necessário ter um Cadastro.\n");
    				printf("\nSe Você Ainda não Possui Um Cadastro, Faça um em 'Menu Principal'/'Fazer Cadastro')\n");
    				...
    				switch(escolher_evento){
    					case 1:
							...
							printf("\n[ATENÇÃO: OS INGRESSOS SÃO VÁLIDOS DURANTE TODO O DIA QUE VOCÊ DEFINIU, SEM UM HORÁRIO ESPECÍFICO PARA ENTRAR.");
							printf("\nVocê Pode Consultar o Horário Das Exposições no 'Menu Principal' na Opção 'Verificar Disponibilidade.')\n");
    			...
    			case 3:
    				...
    				switch(sair_da_compra){
    					...
    					case 2:
    						...
    						printf("DIGITE A PRIMEIRA SEQUÊNCIA DE 4 DÍGITOS:");
    						scanf("%d", &pag_cartao.numero_cartao_sum);
    						fflush(stdin);
    						printf("DIGITE A SEGUNDA SEQUÊNCIA DE 4 DÍGITOS:");
    						scanf("%d", &pag_cartao.numero_cartao_sdois);
    						fflush(stdin);
    						printf("DIGITE A TERCEIRA SEQUÊNCIA DE 4 DÍGITOS:");
    						scanf("%d", &pag_cartao.numero_cartao_stres);
    						fflush(stdin);
    						printf("DIGITE A QUARTA SEQUÊNCIA DE 4 DÍGITOS:");
							...
							switch(credito_ou_debito){
								...
								case 2:
    				                ...
    				                printf("\n| %s", sttspag);
    				                printf("\n------------------------------------------------------------------------------");
    				                printf("\n\n1. Finalizar Pagamento e Retornar ao Inicio da Pagina:");
    				                scanf("%d", &sair_da_compra);
    				                fflush(stdin);
    				                switch(sair_da_compra){
    				                	case 1:
    			...
    			case 4:
    				...
    				printf("\n-------------------------------");
    				printf("\n\nBem-vindo ao Art&tech, o museu multitematico que combina arte e tecnologia! Aqui voce encontrara uma experiencia unica e imersiva. Estamos abertos todos os dias da semana, incluindo fins de semana, das 09:00h as 18:00h.");
    				printf("\n\nNossa missao a oferecer um espaco onde a arte e a tecnologia se encontram, proporcionando uma jornada fascinante pelo mundo da criatividade e inovando. No Art&tech, voce podera explorar diversas exposicoes que abrangem desde pinturas classicas ate instalacoes interativas e obras digitais.");
    				printf("\nGracas ao nosso horario de funcionamento estendido, voce tem flexibilidade para visitar o museu em qualquer dia da semana. \nSeja em uma tarde tranquila de domingo ou durante a agitacao dos dias uteis, estaremos aqui para recebe-lo.");
    				printf("\nAlem disso, nossa equipe de curadores e guias esta pronta para enriquecer a sua experiencia, fornecendo informacoes detalhadas sobre as exposicoes e respondendo a todas as suas perguntas. Nao perca a oportunidade de conhecer o Art&tech e mergulhar em um universo fascinante de arte e tecnologia. Esperamos ve-lo em breve!");
    				
    				printf("\n\n\n\n\n1. Retornar ao Inicio da Pagina:");
    				scanf("%d", &sair_disp);
    				fflush(stdin);
    				switch(sair_disp){
    					case 1:
    			...
    			case 5:	
    			    system("cls");
    			    printf("\n---CONHECA OS TEMAS DISPONEVEIS---");
    				printf("\n----------------------------------\n");
    				printf("\n100 Anos da Semana de Arte Moderna\n");
    			    printf("\n1- Obra - Abaporu");
    			    printf("\n'Abaporu' iconica obra da pintora brasileira Tarsila do Amaral, criada em 1928, que e amplamente considerada uma das mais importantes do movimento modernista brasileiro. Esta pintura e conhecida por seu estilo unico e sua representacao surrealista de uma figura feminina.");
    			    printf("\n\n2- Obra - Georgina");
    			    printf("\nA criacao de Anita Malfatti em 1914, intitulada 'Georgina', e uma obra de arte que se destaca pela sua representacao de uma figura feminina. A pintura retrata uma mulher com uma expressao intrigante e enigmatica.");
    				printf("\n\n3 - Obra - Mulher de cabelos verdes");
    				printf("\nA obra 'A Mulher de Cabelos Verdes', criada por Anita Malfatti em 1915, e uma pintura que chama a atencao por sua natureza ousada e expressiva. No centro da pintura temos a mulher com o cabelo verde, um cabelo nao tao tradicional para aquela epoca que torna a atmosfera da obra unica.");
    				
    				printf("\n\n\n\n150 Anos de Santos Dumont\n");
    				printf("\n4 - Obra - 14 Bis Santos Dumont");
    				printf("\nO 14-Bis desempenhou um papel crucial na historia da aviacao, marcando a primeira demonstracao publica bem-sucedida de um voo em uma aeronave controlada, esempenhou um papel crucial na historia da aviacao, marcando a primeira demonstracao publica bem-sucedida de um voo em uma aeronave controlada.");
    				printf("\n\n5 Obra - casa de Santos Dumont");
    				printf("\n'A Encantada' era a casa de verao de Alberto Santos Dumont, Pai da Aviacao. Possui objetos, livros, cartas e mobiliorio, alem de um chuveiro e uma escada com degraus em forma de raquete que so podem ser alcancados com o pa direito. O local tem maquetes tateis para pessoas com necessidades especiais e e facilmente acessivel.");
    				printf("\n\n6 - Obra - Relogio a invencao de Santos Dumont");
    				printf("\nAlberto Santos-Dumont, um pioneiro da aviacao brasileiro e uma figura chave na historia da aviacao, desempenhou um papel crucial na popularizacao do relogio de pulso como uma peca de moda e funcionalidade.");
    			    printf("\n\n\n\nJogos Olímpicos de Paris 2024\n");
                    ...
                    printf("\nCasa do Olympique de Marselha desde a construção do local, em 1937, o Estádio Vélodrome já recebeu partidas das seleções francesas de futebol e todas as principais competições organizadas em solo francês.");
